...
export const CategoriesFilter = ({
  ...
  return (
    <motion.div 
      ...
      className="bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700/50 shadow-sm p-3 mb-4"
    >
      ...
      <AnimatePresence>
        {showFilters && (
          ...
          >
            <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700/50 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              {/* Status Filter */}
              <div>
